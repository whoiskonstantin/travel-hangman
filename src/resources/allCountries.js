export const allCountries = [
  ...
  },
  {
    ...
    cioc: '',
    recognised: false,
    capitalSpecial: 'Port-aux-Français'
  },
  {
    name: 'Gabon',
    topLevelDomain: ['.ga'],
